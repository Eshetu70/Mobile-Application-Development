...
public class DetailsFragment extends Fragment {
    ...
    private static final String ARG_PARAM_DETIALS= "ARG_PARAM_DETIALS";
    ...
    public static DetailsFragment newInstance(Contact contact) {
        ...
        args.putSerializable(ARG_PARAM_DETIALS, contact);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mContact = (Contact) getArguments().getSerializable(ARG_PARAM_DETIALS);
